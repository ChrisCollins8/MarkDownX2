...
namespace WeifenLuo.WinFormsUI.Docking.Skins
{
    internal static class DockPanelSkinBuilder
    {
        ...
        private static DockPanelSkin CreateVisualStudio2005()
        {
            ...
            skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.StartColor = Color.White; // SystemColors.Control;
            skin.DockPaneStripSkin.ToolWindowGradient.ActiveTabGradient.EndColor = Color.White; //SystemColors.Control;
