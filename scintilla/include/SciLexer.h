...
/**
 * Reusing the HB (VBScript) fields for PHP. don't want to effectively break
 * the VBS fields but we do want to be able to reference them. and use them.
 * more easily.
#define SCE_HB_START 70
#define SCE_HB_DEFAULT 71
#define SCE_HB_COMMENTLINE 72
...
#define SCE_HB_STRINGEOL 77
 */
#define SCE_HPHP_FUNCTION 74
#define SCE_HPHP_PROPERTY 71
#define SCE_HPHP_NAMESPACE 70
#define SCE_HPHP_OBJECT 76
