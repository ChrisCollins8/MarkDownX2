...
static int getLineEnd(unsigned int startPos, int length, int initStyle, Accessor &styler){
	...
	while (sc.More()) {
		...
		*/
		...
		// Emphasis
			...
			// Header
			if (sc.Match("######"))
				SetStateAndZoom(SCE_MARKDOWN_HEADER6, getLineEnd(startPos, length, initStyle, styler), '#', sc);
			else if (sc.Match("#####"))
				SetStateAndZoom(SCE_MARKDOWN_HEADER5, getLineEnd(startPos, length, initStyle, styler), '#', sc);
			else if (sc.Match("####"))
				SetStateAndZoom(SCE_MARKDOWN_HEADER4, getLineEnd(startPos, length, initStyle, styler), '#', sc);
			else if (sc.Match("###"))
				SetStateAndZoom(SCE_MARKDOWN_HEADER3, getLineEnd(startPos, length, initStyle, styler), '#', sc);
			else if (sc.Match("##"))
				SetStateAndZoom(SCE_MARKDOWN_HEADER2, getLineEnd(startPos, length, initStyle, styler), '#', sc);
			else if (sc.Match("#")) {
				...
				if (sc.chNext == '.' && IsASpaceOrTab(sc.GetRelative(2))) {
					...
					SetStateAndZoom(SCE_MARKDOWN_HEADER1, getLineEnd(startPos, length, initStyle, styler), '#', sc);
			}
			// Code block
			else if (sc.Match("~~~")) {
